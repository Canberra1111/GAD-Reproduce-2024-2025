...
def pre_test(features):
    ...
    parser.add_argument('-c', '--config', type=str, default='ddpm/config/test.json',
    ...
    test_set = Data.create_dataset(opt['datasets']['test'],features, 'test')
    global test_loader
    ...
    logging.shutdown()
    return time_test(params, strategy_params, temp_list)
